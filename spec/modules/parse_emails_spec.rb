...
describe Modules::EmailList do
  ...
  describe ".parse" do
    it "accepts an comma separated string of emails" do
      expect { Modules::EmailList.parse(emails) }.not_to raise_error
    end

    it "separates the list of email in to an array" do
      email_array = Modules::EmailList.parse(emails)
    ...
    it "accurately separates a list separated by semicolons" do
      email_array = Modules::EmailList.parse(emails_with_semicolons)
    ...
    it "accurately separates emails even if there is no space after commas" do
      email_array = Modules::EmailList.parse(emails_without_spaces)
